      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white dark:bg-gray-800 border rounded-2xl overflow-hidden md:flex">
          ...
          <div className="md:w-1/3 bg-gray-50 dark:bg-gray-800 p-8 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-600">
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-4 text-center">
              {data?.data?.name}
            </h2>
          ...
          <div className="md:w-2/3 p-8 flex flex-col justify-between">
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6 border-b pb-2 border-gray-200 dark:border-gray-700">
                Profile Details
              </h3>
              <div className="space-y-6">
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">User ID</p>
                  <p className="text-lg font-normal text-gray-800 dark:text-gray-200 mt-1">
                    {data?.data?._id || "N/A"}
                  </p>
                </div>
                <div>
